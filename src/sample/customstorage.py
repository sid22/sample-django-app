...
class CustomManifestLocalStorage(ManifestFilesMixin, StaticFilesStorage):
    pass
...
class CustomManifestS3Boto3Storage(ManifestFilesMixin, S3Boto3Storage):
    ...
    manifest_location = os.path.abspath(
        settings.BASE_DIR
    )  # or settings.PROJECT_ROOT depending on how you've set it up in your settings file.
